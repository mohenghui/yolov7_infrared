...
class MainWindow(QMainWindow):
    ...
    def onnx_run(self,img):
        ...
        result=[]
        for i,(batch_id,x0,y0,x1,y1,cls_id,score) in enumerate(outputs):
            result.append(outputs[x0,y0,x1,y1,cls_id])
        return result
    def init_model(self):
        ...
        while self.g_open:
            ...
            if self.start_predict:
                ...
                if result:
                    ...
                    # new_result = scale_coords_new((480,640), result[:4], (self.get_img.shape[0], self.get_img.shape[1]))
                    self.predict_lable.setText(
