...
# from inferared_class import Camera_server
import sys
...
class ChildWindow(QWidget):
    ...
    def enum_devices(self):
        ...
        if ret != 0:
            print('show error', 'enum devices fail! ret = ' + (ret))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.file_path="..\\..\\pic\\test_stamp.jpg"
...
# python export.py --weights yolov7-tiny.pt --grid --end2end --simplify --topk-all 100 --iou-thres 0.65 --conf-thres 0.35 --img-size 640 640 --max-wh 640
    ...
    def initUI(self):
        ...
        self.button_open_infrared=QAction("使用红外摄像头",self)
        self.button_open_infrared.setStatusTip("打开红外摄像头")
        self.button_open_infrared.triggered.connect(self.open_infrared)

        self.button_close_infrared=QAction("关闭红外摄像头",self)
        self.button_close_infrared.setStatusTip("关闭红外摄像头")
        self.button_close_infrared.triggered.connect(self.close_infrared)
        self.file_menu.addAction(self.button_menu)
        self.file_menu.addAction(self.button_open_infrared)
        self.file_menu.addAction(self.button_close_infrared)
    ...
    def close_infrared(self):
        # self.infrared=Camera_server()
        self.infrared.release()
        # self.infrared=None
    def open_infrared(self):
        # self.scale=1
        self.infrared=HKCam()
        # while True:
        #     img = self.infrared.read()[1]
        #     # last_stamp=n_stamp
